...
public class ZipTest {
	...
	public static void main(String[] args) throws Exception {
		...
		String desktopPath = "C:\\Users\\guoshaocheng\\Desktop";
		ZipTest zipTest = new ZipTest();
		zipTest.zip(desktopPath + "\\beforezip", desktopPath, "afterZip.zip");
		// zipTest.unzip(desktopPath + "\\afterZip.zip", desktopPath, true);
	}
	...
	public void test1() throws IOException {
		...
		String desktopPath = "C:\\Users\\guoshaocheng\\Desktop";
		ZipFile zip = new ZipFile(desktopPath + "\\test.zip");
		...
		while (entries.hasMoreElements()) {
			...
			entryFilePath = desktopPath + File.separator + entry.getName();
			...
			InputStreamReader isr = new InputStreamReader(bis);// 字符流
	...
	public static void zip(String srcPath, String zipPath, String zipFileName)
		...
		try {
			...
			// ICommonResultCode.INVALID_PARAMETER,
